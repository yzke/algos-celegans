# ALGOS · 秀丽虫数字实现 · 设计文档 v0.2

> 项目代号: ALGOS-Celegans
> 文档版本: 0.2 (2026-05-20)
> 前版本: drift_design_draft.md, celegans_design_draft.md
> 修订原因: 多次理论自审发现的偏离与工程细节澄清
...
| 数据 | 主来源建议 | 状态 |
|---|---|---|
| W_chem 连接矩阵 | Cook et al. 2019 Nature | 待集成 |
| W_gap 连接矩阵 | Cook et al. 2019 Nature | 待集成 |
| 神经元递质类型 | Pereira 2015 / Serrano-Saiz 2013 / Gendrel 2016 + WormAtlas | 待集成 |
...
*Status: v0.2 设计文档,主参考*
*下一步: phase0_implementation.md(给 Claude Code 的阶段 0 任务书)*